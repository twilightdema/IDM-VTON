...
python3 train_sd15.py --gradient_checkpointing --mixed_precision=fp16 --use_8bit_adam --output_dir=result_sd15 --train_batch_size=2 --data_dir=/home/nok/Downloads/zalando-hd-resized
